...
const canManageWorkspaceLibrary = computed(() =>
    ...
    <header class="space-y-4 px-2">
      ...
      <div class="flex items-center justify-between border-y border-border-subtle dark:border-white/[0.05] py-2">
        ...
        <div class="flex items-center gap-2">
          ...
          <UiButton v-if="canManageWorkspaceLibrary" variant="primary" size="sm" class="h-8 gap-1.5"><Plus :size="14" /> Create New</UiButton>
        </div>
      </div>
    </header>
