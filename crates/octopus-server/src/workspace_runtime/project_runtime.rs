...
pub(super) fn strip_runtime_transport_escape_hatches(value: &mut serde_json::Value) {
    match value {
...
pub(super) fn normalize_project_string_list(values: Vec<String>) -> Vec<String> {
...
pub(super) fn visible_inbox_items(
    user_id: &str,
...
pub(super) fn normalize_project_assignments(
...
pub(super) fn project_workspace_assignments(
...
pub(super) struct ProjectGrantedScope {
    pub(super) workspace_active_agent_ids: BTreeSet<String>,
    pub(super) agents: Vec<octopus_core::AgentRecord>,
    pub(super) teams: Vec<octopus_core::TeamRecord>,
    pub(super) tool_source_keys: Vec<String>,
}
...
pub(super) async fn load_project_runtime_document(
    state: &ServerState,
    project: &ProjectRecord,
...
pub(super) async fn validate_create_project_leader(
    state: &ServerState,
...
pub(super) async fn validate_updated_project_leader(
    state: &ServerState,
    project: &ProjectRecord,
...
pub(super) async fn validate_project_runtime_leader(
    state: &ServerState,
    project: &ProjectRecord,
