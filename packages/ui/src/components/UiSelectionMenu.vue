...
<template>
  ...
  >
    ...
    <div :data-testid="props.testId" class="flex flex-col">
      <div v-if="props.title || props.description" class="border-b border-border-subtle px-3 py-2.5">
            ...
            >
              ...
              >
                ...
                <span class="flex shrink-0 items-center gap-2">
                  <span
                    v-if="item.badge"
                    class="rounded px-1.5 py-0.5 bg-subtle text-[9px] font-bold uppercase text-text-tertiary border border-border-subtle"
                  >
                    {{ item.badge }}
                  </span>
