  ...
  >
    <div class="flex items-start gap-4">
      ...
      <div class="flex flex-1 flex-col min-w-0 pt-0.5">
        ...
        <span class="mb-1.5 inline-block text-[10px] font-bold uppercase tracking-widest text-indigo-600/60 truncate">{{ props.title || 'Agent Team' }}</span>
    ...
    <div class="flex items-center justify-between border-t border-border/20 pt-3">
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
          <span class="text-[8px] font-black uppercase tracking-[0.1em] text-text-tertiary/40 leading-none mb-1">Lead</span>
