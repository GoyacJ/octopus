...
| `10-week-7-business-cutover.md` | W7：业务侧切换到 SDK + 删除 `octopus-runtime-adapter` | `draft` |
...
**最后更新**：2026-04-22（W7 子 Plan `10-week-7-business-cutover.md` 已起草并转 `draft`；W6 子 Plan `09-week-6-core-loop.md` 已完成 Weekly Gate）
