...
|---|---:|---:|---:|---:|---:|---:|---|---|
| M0 | 12 | 0 | 0 | 6h | 3h | 4-5d | 待启动 | 派发 M0-T01.5 |
| M1 | 12 | 0 | 0 | 8h | 4h | 4-5d | 待启动 | — |
| M2 | 25 | 0 | 0 | 24h | 12h | 8-10d | 待启动 | — |
| M3 | 21 | 0 | 0 | 25h | 10h | 6-7d | 待启动 | — |
| M4 | 18 | 0 | 0 | 22h | 8h | 5-6d（与 M5 并行）| 待启动 | — |
| M5 | 15 | 0 | 0 | 20h | 10h | 5d（与 M4 并行）| 待启动 | — |
| M6 | 10 | 0 | 0 | 14h | 5h | 3-4d | 待启动 | — |
| M7 | 6 | 0 | 0 | 8h | 6h | 2d | 待启动 | — |
| M8 | 12 | 0 | 0 | 16h | 8h | 4d | 待启动 | — |
| M9 | 8 | 0 | 0 | 12h | 16h | 3-5d | 待启动 | — |
| **合计** | **139** | 0 | 0 | **155h** | **82h** | **40-50d** | — | — |

> **总墙钟估算**：约 14-20 周（3.5-5 个月）。M4/M5 并行节省约 5-6 工作日。
> 如评审者从 1 名增至 2 名，M2/M4/M8 墙钟可压缩 30%-40%（总墙钟降至 11-15 周）。
> 任务卡总数 139 = 132（原计划）+ 7（修订项：M0+4 / M1+2 / M3+1）。
