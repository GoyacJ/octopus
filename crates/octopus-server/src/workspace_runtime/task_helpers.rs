...
pub(crate) fn trim_optional_task_input(value: Option<String>) -> Option<String> {
    value
...
pub(crate) fn task_summary_from_record(record: &ProjectTaskRecord) -> TaskSummary {
    TaskSummary {
        id: record.id.clone(),
...
pub(crate) fn task_run_summary_from_record(record: &ProjectTaskRunRecord) -> TaskRunSummary {
    TaskRunSummary {
        id: record.id.clone(),
...
pub(crate) fn task_intervention_from_record(
...
pub(crate) fn task_detail_from_records(
...
pub(crate) fn task_prompt_from_record(
    task: &ProjectTaskRecord,
    trigger_label: &str,
...
pub(crate) fn build_task_run_record(
    task: &ProjectTaskRecord,
...
pub(crate) fn sync_task_run_record_from_runtime(
...
pub(crate) fn sync_rejected_task_run_record_from_runtime(
    existing: &ProjectTaskRunRecord,
    session: &octopus_core::RuntimeSessionDetail,
    run: &RuntimeRunSnapshot,
) -> ProjectTaskRunRecord {
...
pub(crate) fn update_task_record_from_run(
    task: &ProjectTaskRecord,
    run: &ProjectTaskRunRecord,
    updated_by: &str,
) -> ProjectTaskRecord {
...
pub(crate) fn sync_task_record_from_run(
    task: &ProjectTaskRecord,
    previous_run: &ProjectTaskRunRecord,
    run: &ProjectTaskRunRecord,
    updated_by: &str,
