...
pub(crate) fn definition_source_id(source: DefinitionSource) -> &'static str {
    match source {
        DefinitionSource::ProjectClaw
        | DefinitionSource::ProjectCodex
...
pub(crate) fn definition_source_json(source: DefinitionSource) -> Value {
    json!({
...
pub(crate) fn agent_summary_json(agent: &AgentSummary) -> Value {
    json!({
        "name": &agent.name,
...
pub(crate) fn skill_origin_id(origin: SkillOrigin) -> &'static str {
    match origin {
...
pub(crate) fn skill_origin_json(origin: SkillOrigin) -> Value {
    json!({
...
pub(crate) fn skill_summary_json(skill: &SkillSummary) -> Value {
    json!({
        "name": &skill.name,
