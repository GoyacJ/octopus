...
| M3 | 25 | 25 | 0 | 31h | 12h | 7-8d | 已完成待评审 | M3 Gate 已通过；M4 / M5 待 maintainer 放行 |
| M4 | 19 | 19 | 0 | 22.5h | 8.5h | 5-6d（与 M5 并行）| 已完成待评审 | M5 / M6 可继续；M7 仍需 M5 / M6 完成 |
| M5 | 17 | 17 | 0 | 26h | 13h | 5d（与 M4 并行）| 已完成待评审 | M5 final gate 待 maintainer 评审；不启动 M6 / M7 |
