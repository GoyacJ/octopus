...
describe('OpenAPI transport helpers', () => {
  ...
  it('resolves project agent bundle and workspace copy path templates before making requests', async () => {
    fetchSpy
    ...
    await fetchWorkspaceOpenApi(connection, '/api/v1/projects/{projectId}/agents/import-preview', 'post', {
      session,
      pathParams: {
        projectId: 'proj-redesign',
      },
    ...
    await fetchWorkspaceOpenApi(connection, '/api/v1/projects/{projectId}/agents/import', 'post', {
      session,
      pathParams: {
        projectId: 'proj-redesign',
      },
    ...
    await fetchWorkspaceOpenApi(connection, '/api/v1/projects/{projectId}/agents/export', 'post', {
      session,
      pathParams: {
        projectId: 'proj-redesign',
      },
    ...
    expect(fetchSpy).toHaveBeenNthCalledWith(
      1,
      'http://127.0.0.1:43127/api/v1/projects/proj-redesign/agents/import-preview',
      expect.objectContaining({
        method: 'POST',
        headers: expect.any(Headers),
      }),
    ...
    expect(fetchSpy).toHaveBeenNthCalledWith(
      2,
      'http://127.0.0.1:43127/api/v1/projects/proj-redesign/agents/import',
      expect.objectContaining({
        method: 'POST',
        headers: expect.any(Headers),
      }),
    ...
    expect(fetchSpy).toHaveBeenNthCalledWith(
      3,
      'http://127.0.0.1:43127/api/v1/projects/proj-redesign/agents/export',
      expect.objectContaining({
        method: 'POST',
        headers: expect.any(Headers),
      }),
    ...
    expect(fetchSpy).toHaveBeenNthCalledWith(
      4,
      'http://127.0.0.1:43127/api/v1/workspace/agents/agent-project-1/copy-to-workspace',
      expect.objectContaining({
        method: 'POST',
        headers: expect.any(Headers),
      }),
    ...
    expect(fetchSpy).toHaveBeenNthCalledWith(
      5,
      'http://127.0.0.1:43127/api/v1/workspace/teams/team-project-1/copy-to-workspace',
      expect.objectContaining({
        method: 'POST',
        headers: expect.any(Headers),
      }),
  ...
  it('keeps project agent bundle and workspace promotion routes in the generated transport contract', () => {
    const generated = readFileSync(
      resolve(import.meta.dirname, '../../../packages/schema/src/generated.ts'),
      'utf8',
    )

    expect(generated).toContain('"/api/v1/projects/{projectId}/agents/import-preview"')
    expect(generated).toContain('"/api/v1/projects/{projectId}/agents/import"')
    expect(generated).toContain('"/api/v1/projects/{projectId}/agents/export"')
    expect(generated).toContain('"/api/v1/workspace/agents/{agentId}/copy-to-workspace"')
    expect(generated).toContain('"/api/v1/workspace/teams/{teamId}/copy-to-workspace"')
    expect(generated).toContain('operationId: "previewProjectAgentBundleImport"')
    expect(generated).toContain('operationId: "importProjectAgentBundle"')
    expect(generated).toContain('operationId: "exportProjectAgentBundle"')
    expect(generated).toContain('operationId: "copyWorkspaceAgentToWorkspace"')
    expect(generated).toContain('operationId: "copyWorkspaceTeamToWorkspace"')
  })
})
