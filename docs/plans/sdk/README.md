...
| `11-week-8-cleanup-and-split.md` | W8：文件级拆分、`octopus-persistence` 上线、legacy 文件退场 | `draft` |
...
**最后更新**：2026-04-22（W7 子 Plan `10-week-7-business-cutover.md` 已完成 Weekly Gate；W8 子 Plan `11-week-8-cleanup-and-split.md` 已补齐控制字段并完成文档审计修复，状态 `draft`）
