...
describe('desktop locale registry', () => {
  ...
  it('covers the required shell, enum, and mock namespaces', () => {
    ...
    expect(keys).toContain('mock.settingsSection.audit.description')
