...
<template>
  <div class="flex min-h-screen items-center justify-center bg-background px-6 py-10">
    <div class="grid w-full max-w-5xl overflow-hidden rounded-[16px] border border-border bg-surface shadow-sm lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
        ...
        <div class="mx-auto max-w-xl">
          ...
          <div class="mt-6">
            <div
              ...
              class="rounded-[12px] border border-border bg-subtle px-4 py-6 text-sm text-text-secondary"
            >
              正在加载登录上下文…
            </div>
            <div
              ...
              class="rounded-[12px] border border-border bg-card p-6"
            >
              <AuthGateForm inline />
            </div>
          </div>
