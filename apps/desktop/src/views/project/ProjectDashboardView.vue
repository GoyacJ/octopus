  ...
  <div class="w-full space-y-12 pb-20">
    ...
    <UiPageHero data-testid="project-dashboard-hero" class="px-2">
      ...
      <template #actions>
        ...
        <RouterLink
          :to="{ name: 'project-knowledge', params: { workspaceId: workbench.currentWorkspaceId, projectId: workbench.currentProjectId } }"
        ...
        <RouterLink
          :to="{ name: 'project-trace', params: { workspaceId: workbench.currentWorkspaceId, projectId: workbench.currentProjectId } }"
          class="block min-w-0 no-underline"
    ...
    <section class="space-y-8 px-2 pt-8 border-t border-border-subtle dark:border-white/[0.02]">
      <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
          <UiButton v-if="canManageProject && !editing" variant="ghost" size="sm" data-testid="project-dashboard-edit" @click="startEdit">{{ t('common.edit') }}</UiButton>
          <template v-else-if="canManageProject && editing">
