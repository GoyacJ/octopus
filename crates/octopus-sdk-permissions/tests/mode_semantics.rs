...
const EXPECTED_DECISIONS: [(PermissionMode, ToolCategory, &str); 16] = [
    ...
    (PermissionMode::BypassPermissions, ToolCategory::Read, "allow"),
    (PermissionMode::BypassPermissions, ToolCategory::Write, "allow"),
    (PermissionMode::BypassPermissions, ToolCategory::Shell, "allow"),
    (PermissionMode::BypassPermissions, ToolCategory::Subagent, "allow"),
