...
pub(crate) fn provider() -> Provider {
    Provider {
        ...
        surfaces: vec![
            SurfaceId("deepseek.conversation".to_string()),
            SurfaceId("deepseek.anthropic".to_string()),
        ],
    }
}
...
pub(crate) fn surfaces() -> Vec<Surface> {
    vec![
        ...
        Surface {
            id: SurfaceId("deepseek.anthropic".to_string()),
            provider_id: ProviderId("deepseek".to_string()),
...
pub(crate) fn models() -> Vec<Model> {
    vec![
        ...
        Model {
            id: ModelId("deepseek-reasoner".to_string()),
            surface: SurfaceId("deepseek.conversation".to_string()),
            family: "deepseek-reasoner".to_string(),
            track: ModelTrack::LatestAlias,
            context_window: ContextWindow {
                max_input_tokens: 128_000,
                max_output_tokens: 8_192,
            ...
            aliases: vec!["deepseek-reasoner".to_string()],
        },
    ]
}
